                ...
                <div class="card-body">
                  <form action="registerAction.php" method="POST">
                    ...
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" name="maleCb" id="flexSwitchCheckDefault">
                      <label class="form-check-label" for="flexSwitchCheckDefault">Male</label>
                    </div>
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" name="othersCb" id="flexSwitchCheckChecked" checked>
